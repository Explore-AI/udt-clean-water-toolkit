...
from cwageodjango.core.constants import DEFAULT_SRID, WATER_FACILITY_CONNECTION__NAME
...
class WaterFacilityConnection(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_water_facility_connections")
    ...
    class AssetMeta:
        asset_name = WATER_FACILITY_CONNECTION__NAME
