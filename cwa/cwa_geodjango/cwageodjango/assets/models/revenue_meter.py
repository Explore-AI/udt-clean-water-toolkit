...
from cwageodjango.core.constants import DEFAULT_SRID, REVENUE_METER__NAME


class RevenueMeter(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_revenue_meters")
    ...
    class AssetMeta:
        asset_name = REVENUE_METER__NAME
