...
from cwageodjango.core.constants import DEFAULT_SRID, INSERTION_FLOW_METER__NAME


class InsertionFlowMeter(models.Model):
    gid = models.IntegerField(null=False, blank=False, unique=True, db_index=True)
    status = models.CharField(max_length=255, null=False, blank=False, db_index=True)
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_insertion_flow_meters")
    ...
    class AssetMeta:
        asset_name = INSERTION_FLOW_METER__NAME
