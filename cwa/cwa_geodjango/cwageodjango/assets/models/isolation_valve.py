...
from cwageodjango.core.constants import DEFAULT_SRID, ISOLATION_VALVE__NAME


class IsolationValve(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_isolation_valves")
    ...
    class AssetMeta:
        asset_name = ISOLATION_VALVE__NAME
