...
from cwageodjango.core.constants import DEFAULT_SRID, BOREHOLE__NAME
...
class Borehole(models.Model):
    ...
    dmas = models.ManyToManyField(DMA, related_name="dma_boreholes")
