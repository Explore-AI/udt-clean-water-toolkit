...
from cleanwaterapp_geod.utilities.models import DMA
...
# https://networkx.org/documentation/stable/auto_examples/geospatial/plot_lines.html#sphx-glr-auto-examples-geospatial-plot-lines-py
def analysis():
    print("success")
