...
router.register(r"geojson/trunk_main",TrunkMainGeoJsonViewSet, "trunk_main-geojson")
router.register(r"distribution_main", DistributionMainViewSet, basename="distribution_main")
router.register(r"geojson/distribution_main", DistributionMainGeoJsonViewSet, "distribution_main-geojson")
...
router.register(r"geojson/network_meter", NetworkMeterGeoJsonViewSet, "network_meter-geojson")
router.register(r"network_opt_valve", NetworkOptValveViewSet, basename="network_opt_valve")
router.register(r"geojson/network_opt_valve", NetworkOptValveGeoJsonViewSet, "network_opt_valve-geojson")
router.register(r"operational_site", OperationalSiteViewSet, basename="operational_site")
router.register(r"geojson/operational_site", OperationalSiteGeoJsonViewSet, "operational_site-geojson")
router.register(r"pressure_control_valve", PressureControlValveViewSet, basename="pressure_control_valve")
router.register(r"geojson/pressure_control_valve", PressureControlValveGeoJsonViewSet, "pressure_control_valve-geojson")
router.register(r"pressure_fitting", PressureFittingViewSet, basename="pressure_fitting")
router.register(r"geojson/pressure_fitting", PressureFittingGeoJsonViewSet, "pressure_fitting-geojson")
